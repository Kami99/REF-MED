let idLon = document.querySelector('.location_lon_doctor').getAttribute('id');
let idLat = document.querySelector('.location_lat_doctor').getAttribute('id');
let marker, myMap
window.onload=()=>{
    myMap = L.map('map_doctor').setView([14.6937000, -17.4440600], 13);
