...
class DoctorType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('numberPhone', new Assert\Regex([
                'pattern' => '/(0|\+221)[1-12]( *[0-9]{2}){4}/',
                'htmlPattern' => '(0|\+221)[1-12]( *[0-9]{2}){4}',
                'message' => 'Votre numero doit être conforme à ceux des Opérateurs sur le compte Sénégalais',
            ]))
