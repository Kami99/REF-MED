...
class AppointmentSubscriber implements EventSubscriberInterface
{
    ...
    public function __construct( AppointmentRepository $appointmentRepository, UrlGeneratorInterface $router,TokenStorageInterface $tokenStorage ) {
    ...
    public function onCalendarSetData(CalendarEvent $calendar)
    {
        ...
        $appointments = $this->appointmentRepository->findAllConfirmedAppoint($user, $calendar);
