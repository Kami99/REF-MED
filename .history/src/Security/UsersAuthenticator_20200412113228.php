...
class UsersAuthenticator extends AbstractFormLoginAuthenticator implements PasswordAuthenticatedInterface
{
    ...
    public function getUser($credentials, UserProviderInterface $userProvider)
    {
        ...
        if (!$user) {
            ...
            throw new CustomUserMessageAuthenticationException("Votre Email est incorrecte ou vous n'êtes pas inscrit");
        }
    ...
    public function onAuthenticationSuccess(Request $request, TokenInterface $token, $providerKey)
    {
        ...
        return new RedirectResponse($this->urlGenerator->generate('homeBlog'));    
    }
