...
use App\Form\EditAvailableDrugsType;
...
class PharmacyAvailabeDrugsController extends AbstractController
{
     ...
     */
    public function index(DrugsRepository $drugsRepository, PharmacyAvailabeDrugsRepository $pharmacyAvailabeDrugsRepository): Response
    {
            $drugs=$drugsRepository->findAll();
            $current_user = $this->getUser();
        return $this->render('pharmacy_availabe_drugs/index.html.twig', [
            'drugs' => $drugsRepository->findAll(),
            'availables' => $pharmacyAvailabeDrugsRepository->findAll(),
    ...
    public function new(Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->addFlash(
                'success',
                "Ce médicament a bien été ajouter"
            );
    ...
    {
        $current_user = $this->getUser();
        $form = $this->createForm(EditAvailableDrugsType::class, $pharmacyAvailabeDrug);
        $form->handleRequest($request);
