...
class BlogController extends AbstractController
{
     ...
     */
    public function showArticle(Articles $article, string $slug, Request $request)
    {
        
        
        $keywords=$this->keywordRepository->findAllVisible();
        $postsPopular=$this->articlesRepository->findPopularPost();  
          $commentaires=$this->CommentairesRepository->findAllVisible();
    ...
    public function createPost(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->addFlash(
                'success',
                "Votre article a été ajoutez"
            );
            return $this->redirectToRoute('home');
        }
        return $this->render('blog/createPost.html.twig', [
            'form'=>$form->createView(),
            'keywords'=>$keywords,
        ]);
    }
