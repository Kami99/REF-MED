...
class Doctor extends Users
{
    ...
    /**
     * @Assert\Regex("#^[a-zA-Z]{4,10}$#", message="Elle ne doit pas contenir de caractères spéciaux ou de chiffres")
     * 
    ...
    /**
     * @Assert\Regex("#^[a-zA-Z]{4,10}$#", message="Ce champ ne doit pas contenir de caractères spéciaux ou de chiffres")
     *@ORM\Column(type="string", length=255)
     */
    private $LastName;
