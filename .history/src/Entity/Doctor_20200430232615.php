...
class Doctor extends Users
{
    ...
    /**
     * @Assert\Length(min = 8, max = 12, minMessage = "min_lenght", maxMessage = "max_lenght")
     * @Assert\Regex(pattern="/^\+221\(0\)[0-9]*$", message="number_only") 
     * @ORM\Column(type="integer")
     */
    private $numberPhone;
    ...
    /**
     * @var File|null
     * @Vich\UploadableField(mapping="pictureProfile", pictureProfilProperty="pictureProfil")
     */
    private $imageFile;
    /**
    ...
    public function removeRefund(Refund $refund): self
    {
        ...
        /**
     * Get the value of pictureProfil
     *
     * @return  string|null
     */ 
    ...
    /**
     * Set the value of pictureProfil
     *
     * @param  string|null  $pictureProfil
     *
     * @return  self
     */ 
    public function setFileName($pictureProfil)
    {
        $this->pictureProfil = $pictureProfil;
