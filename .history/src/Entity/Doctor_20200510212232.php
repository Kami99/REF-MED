...
class Doctor extends Users
{
    ...
    /**
     * @Assert\Regex("#^[a-zA-Z]{2,120}$#", message="Ce champ ne doit pas contenir de caractères spéciaux ou de chiffres")
     *@ORM\Column(type="string", length=255)
     */
    private $LastName;
    ...
    {
        $this->tarifMax=number_format($this->tarifMax , 2 ," "," ");
        $this->tarifMax=number_format($this->tarifMin , 2 ," "," ");
       return "{$this->tarifMin} - {$this->tarifMax}";
    }
