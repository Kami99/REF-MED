 ...
 * @UniqueEntity(fields={"email"}, message="Un compte existe déja avec cet Email veuillez essayez avec un autre")
 * 
 */
class Doctor extends Users
{
    ...
    /**
     * @Assert\Regex("/^[a-zA-Z]+$/#", message="Elle ne doit pas contenir de caractères spéciaux ou de chiffres")
     * 
    ...
    /**
     * @Assert\Regex("/^[a-zA-Z]+$/#", message="Ce champ ne doit pas contenir de caractères spéciaux ou de chiffres")
     *@ORM\Column(type="string", length=255)
     */
    private $LastName;

    /**
     * @Assert\Regex("#^\+(221)-[0-9]{2}-[0-9]{3}-[0-9]{2}-[0-9]{2}$#", message="Votre numéro doit être un numéro Sénégalais commençant par +221")
     * @ORM\Column(type="string", length=255)
     */
    private $numberPhone;
