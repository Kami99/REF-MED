...
class Doctor extends Users
{
    ...
    /**
     * @Assert\Length(min = 15, max = 15, minMessage = "min_lenght", maxMessage = "max_lenght")
     * @Assert\Regex("#/ ^ \ [-+](1|10|25)[0-9]{2}-[0-9]{3}-[0-9]{2}-[0-9]{2} $ /#", message="Votre numéro doit être un numéro Sénégalais commençant par +221")
     * @ORM\Column(type="string", length=255)
     */
    private $numberPhone;
