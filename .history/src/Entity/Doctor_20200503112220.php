...
class Doctor extends Users
{
    ...
    /**
     * @Assert\Length(min = 17, max = 17, minMessage = "min_lenght", maxMessage = "max_lenght")
     * @Assert\Regex("#/^\+(221){3}-[0-9]{3}-[0-9]{3}-[0-9]{4}$//#", message="Votre numéro doit être un numéro Sénégalais commençant par +221")
     * @ORM\Column(type="string", length=255)
     */
    private $numberPhone;
