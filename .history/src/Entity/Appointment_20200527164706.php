...
class Appointment
{
    ...
    /**
     * @Assert\Regex("#^[a-zA-Z]{5,120}.*[\s\.]*$#", message="Votre nom ne doit pas contenir de caractères spéciaux ou de chiffres et doit avoir minimum 5 caractères")
     * 
    ...
    {
        $this->title = "{$this->getName} - {$this->getAppointmentType}";
