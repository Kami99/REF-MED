 ...
 */
final class Version20200602061341 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE article_like ADD CONSTRAINT FK_1C21C7B27294869C FOREIGN KEY (article_id) REFERENCES articles (id)');
        $this->addSql('ALTER TABLE article_like ADD CONSTRAINT FK_1C21C7B2A76ED395 FOREIGN KEY (user_id) REFERENCES users_blog (id)');
        ...
        $this->addSql('ALTER TABLE appointment CHANGE end_at end_at DATETIME DEFAULT NULL, CHANGE days_of_week days_of_week JSON DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE appointment CHANGE end_at end_at DATETIME DEFAULT \'NULL\', CHANGE days_of_week days_of_week LONGTEXT CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_bin`');
