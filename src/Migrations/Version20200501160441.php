...
final class Version20200501160441 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE doctor ADD updated_at DATETIME DEFAULT NULL, ADD created_at DATETIME NOT NULL, CHANGE picture_profil picture_profil VARCHAR(255) DEFAULT NULL, CHANGE tarif_min tarif_min DOUBLE PRECISION DEFAULT NULL, CHANGE tarif_max tarif_max DOUBLE PRECISION DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE laboratory ADD updated_at DATETIME DEFAULT NULL, ADD created_at DATETIME NOT NULL');
        ...
        $this->addSql('ALTER TABLE pharmacy ADD updated_at DATETIME NOT NULL, ADD created_at DATETIME NOT NULL, CHANGE picture picture VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE commentaires CHANGE updated_at updated_at DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE doctor DROP updated_at, DROP created_at, CHANGE picture_profil picture_profil VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE tarif_min tarif_min DOUBLE PRECISION DEFAULT \'NULL\', CHANGE tarif_max tarif_max DOUBLE PRECISION DEFAULT \'NULL\'');
        ...
        $this->addSql('ALTER TABLE laboratory DROP updated_at, DROP created_at');
        $this->addSql('ALTER TABLE location CHANGE latitude latitude DOUBLE PRECISION DEFAULT \'NULL\', CHANGE longitude longitude DOUBLE PRECISION DEFAULT \'NULL\'');
        ...
        $this->addSql('ALTER TABLE pharmacy DROP updated_at, DROP created_at, CHANGE picture picture VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
