 ...
 */
final class Version20200409104138 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE skills (id INT AUTO_INCREMENT NOT NULL, title_skills VARCHAR(255) NOT NULL, percent_skills INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
