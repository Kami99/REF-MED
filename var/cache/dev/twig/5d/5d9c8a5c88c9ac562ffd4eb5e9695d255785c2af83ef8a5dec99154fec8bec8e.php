...
class __TwigTemplate_cd89c3dc1ed7da6004b9030b572f7c5575fb91f97ca6e43fda8b14202654afc3 extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"row top\">
    ...
    <div class=\"col-eight md-six tab-full popular\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["postsPopular"]) {
            ...
            // line 23
            echo twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["popularPosts"]) || array_key_exists("popularPosts", $context) ? $context["popularPosts"] : (function () { throw new RuntimeError('Variable "popularPosts" does not exist.', 23, $this->source); })()), "updatedAt", [], "any", false, false, false, 23), "d-m-Y à H:i:s"), "html", null, true);
            echo "</time></span>
                </section>
            </article>
            ";
        ...
        <div class=\"block-1-2 block-m-full popular__posts\">
            {% for postsPopular in popular_posts %}
                ...
                <section class=\"popular__meta\">
                    ...
                    <span class=\"popular__date\"><span>Poster le </span> <time datetime=\"\">{{popularPosts.updatedAt|date(\"d-m-Y à H:i:s\")}}</time></span>
                </section>
            </article>
            {% endfor %}
