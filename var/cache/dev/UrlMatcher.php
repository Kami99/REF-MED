    ...
    [ // $regexpList
        0 => '{^(?'
                ...
                .'|/media/cache/resolve/(?'
                    ...
                    .'|([A-z0-9_-]*)/(.+)(*:294)'
                .')'
                .'|/admin/core/get\\-short\\-object\\-description(?:\\.(html|json))?(*:364)'
            .')/?$}sD',
    ],
    [ // $dynamicRoutes
        ...
        364 => [
            [['_route' => 'sonata_admin_short_object_information', '_controller' => 'sonata.admin.action.get_short_object_description', '_format' => 'html'], ['_format'], null, null, false, true, null],
